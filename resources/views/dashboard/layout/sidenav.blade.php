    ...
    <nav class="sb-sidenav accordion bg-light" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <div class="collapse" id="tabsc" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="/alltabs">All Tabs</a>
                        <a class="nav-link" href="/upload_tab_csv">Upload CSV</a>
                    </nav>
                </div>
