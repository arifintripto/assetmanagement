...
<table class="tg">
    ...
    <tr>
        <td class="tg-0pky" colspan="3" style="width: 50%;"><strong>Date: </strong>{{ $data->report_date }}</td>
        <td class="tg-0pky" colspan="3" style="width: 50%;"><strong>RSM/ASM: </strong>{{ $data->report_asm_rsm }}</td>
    </tr>
    <tr>
        <td class="tg-c3ow" colspan="6"><strong>Visit Location Details</strong></td>
    </tr>
    <tr>
        <td class="tg-0lax" colspan="3"><strong>Area: </strong>{{ $data->report_area }}</td>
        <td class="tg-0lax" colspan="3"><strong>ASM: </strong>{{ $data->report_asm }}</td>
    </tr>
    <tr>
        <td class="tg-0lax" colspan="3"><strong>Territory: </strong>{{ $data->report_territory }}</td>
        <td class="tg-0lax" colspan="3"><strong>TSO: </strong>{{ $data->report_tso }}</td>
    </tr>
    <tr>
        <td class="tg-0lax" colspan="3"><strong>Town: </strong>{{ $data->report_town }}</td>
        <td class="tg-0lax" colspan="3"><strong>SPO: </strong>{{ $data->report_spo }}</td>
    </tr>
    <tr>
        <td class="tg-0lax" colspan="6"><strong>DB: </strong>{{ $data->report_db }}</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="tg-0pky nowrap" style="width: 15%;"><strong>#Sub DB's</strong></td>
    ...
    <tr>
        ...
        <td class="tg-0pky">{{ ($data->market_focus_sku) == "1" ? "OK" : "Not OK" }}</td>
    </tr>
    <tr>
