...
@section('content')
    <h2 class="mt-4">DB Point Review</h2>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="/">Dashboard</a></li>
        <li class="breadcrumb-item"><a href="{{ route('report.index') }}">Report</a></li>
        <li class="breadcrumb-item active">DB Point Review</li>
    </ol>
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control mb-3 @error('db_avg_sale') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="custom-select custom-select-md mb-3 @error('db_wh_mgmt') is-invalid @enderror"
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control mb-3 @error('db_ytd_gr_percent') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="custom-select custom-select-md mb-3 @error('db_fifo') is-invalid @enderror"
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control mb-3 @error('db_month_target') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="custom-select custom-select-md mb-3 @error('db_stock_register') is-invalid @enderror"
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control mb-3 @error('db_mtd_pry') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control mb-3 @error('db_damage_stk_value') is-invalid @enderror"
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control mb-3 @error('db_mtd_ims') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="custom-select custom-select-md mb-3 @error('db_damage_stk_storage') is-invalid @enderror"
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control mb-3 @error('db_stock_value') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="custom-select custom-select-md mb-3 @error('db_beat_plan') is-invalid @enderror"
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control mb-3 @error('db_sku_carried') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="custom-select custom-select-md mb-3 @error('db_printer_status') is-invalid @enderror"
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control mb-3 @error('db_sku_stockout') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="custom-select custom-select-md mb-3 @error('db_dms_implementation') is-invalid @enderror"
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control mb-3 @error('db_no_of_sub_db') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control mb-3 @error('db_sub_db_avg_sale') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control mb-3 @error('db_sub_db_month_sale') is-invalid @enderror"
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control mb-3 @error('db_sub_db_av_sku') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control mb-3 @error('db_sub_db_bills_per_month') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control mb-3 @error('db_sub_db_month_target') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control mb-3 @error('db_sub_db_mtd_lifting') is-invalid @enderror"
