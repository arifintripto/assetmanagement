...
@section('content')
    <h2 class="mt-4 mb-4">Market Work With</h2>
            ...
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control  @error('market_beat_visited') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control  @error('market_daily_avg') is-invalid @enderror"
                               id="market_daily_avg"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control  @error('market_day_tgt') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control  @error('market_asking_rate') is-invalid @enderror"
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control  @error('market_total_outlets') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control  @error('market_outlets_worked') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control  @error('market_eff_calls') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control  @error('market_total_memo_value') is-invalid @enderror"
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control  @error('market_av_lpc') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control  @error('market_focus_sku') is-invalid @enderror"
                               id="market_focus_sku"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="custom-select custom-select-md  @error('market_spo_knwl_prep') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="custom-select custom-select-md  @error('market_9steps') is-invalid @enderror"
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <select class="custom-select custom-select-md  @error('market_samples') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="custom-select custom-select-md  @error('market_tab_used') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="custom-select custom-select-md  @error('market_sfa_compliance') is-invalid @enderror"
