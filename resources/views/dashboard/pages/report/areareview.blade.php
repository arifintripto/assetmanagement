...
@section('content')
    <h2 class="mt-4 mb-4">Area/Territory Overview</h2>
            ...
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control @error('area_avg_sale') is-invalid @enderror"
                               id="area_avg_sale"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control @error('area_ytd_gr_percent') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control @error('area_month_target') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control @error('area_mtd_pry') is-invalid @enderror"
                               id="area_mtd_pry"
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control @error('area_mtd_ims') is-invalid @enderror"
                               id="area_mtd_ims"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control @error('area_stock_value') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control @error('area_stock_days') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control @error('area_focus_sku_percent_ach') is-invalid @enderror"
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control @error('area_sku_stockout') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="custom-select custom-select-md @error('area_spo_tgt_knowledge') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="custom-select custom-select-md @error('area_morn_or_eve_meeting') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="custom-select custom-select-md @error('area_sfa_compliance') is-invalid @enderror"
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <select class="custom-select custom-select-md @error('area_spo_rfts_knowledge') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="custom-select custom-select-md @error('area_dsr_status') is-invalid @enderror"
                                id="area_dsr_status"
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="custom-select custom-select-md @error('area_sfa_tabs') is-invalid @enderror"
                                id="area_sfa_tabs"
                                name="area_sfa_tabs">
